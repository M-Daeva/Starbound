...
const server_testnet_workers_1 = require("../common/workers/server-testnet-workers");
function process() {
    return __awaiter(this, void 0, void 0, function* () {
        const { cwSwap, cwTransfer, cwMockUpdatePoolsAndUsers, cwQueryPoolsAndUsers, sgDelegateFromAll, } = yield (0, server_testnet_workers_1.init)();
