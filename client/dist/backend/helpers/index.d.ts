...
import { PoolExtracted, QueryPoolsAndUsersResponse } from "../../common/codegen/StarboundOsmosis.types";
import { RelayerStruct, ValidatorResponseReduced, IbcResponse, NetworkData, AssetDescription, ChainRegistryStorage, IbcChannelsStorage, PoolsStorage, PoolInfo } from "../../common/interfaces";
declare function getPoolList(): Promise<PoolInfo[]>;
...
declare function _verifyRpc(rpcList: string[], prefix: string): Promise<string | undefined>;
declare function _verifyRpcList(prefixAndRpcList: [string, string, string[]][]): Promise<[string, string, string | undefined][]>;
...
declare function getChainRegistry(allowList: [string, string, string[]][], ignoreList: [string, string, string[]][]): Promise<NetworkData[]>;
...
export { updatePoolsAndUsers, getChainRegistry, getIbcChannnels, getPools, getValidators, getUserFunds, filterChainRegistry, mergeChainRegistry, mergeIbcChannels, mergePools, _verifyRpc, _verifyRpcList, _verifyRest, _verifyRestList, getChainNameAndRestList, getIbcChannelList, _modifyRpcList, _getAllGrants, _transformGrantList, requestRelayers, getActiveNetworksInfo, queryPools, getDappAddressAndDenomList, _getChainByChainId, getPoolList, };
