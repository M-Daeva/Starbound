...
exports.getPoolList = exports._getChainByChainId = exports.getDappAddressAndDenomList = exports.queryPools = exports.getActiveNetworksInfo = exports.requestRelayers = exports._transformGrantList = exports._getAllGrants = exports._modifyRpcList = exports.getIbcChannelList = exports.getChainNameAndRestList = exports._verifyRestList = exports._verifyRest = exports._verifyRpcList = exports._verifyRpc = exports.mergePools = exports.mergeIbcChannels = exports.mergeChainRegistry = exports.filterChainRegistry = exports.getUserFunds = exports.getValidators = exports.getPools = exports.getIbcChannnels = exports.getChainRegistry = exports.updatePoolsAndUsers = void 0;
const stargate_1 = require("@cosmjs/stargate");
const clients_1 = require("../../common/account/clients");
const sg_helpers_1 = require("../../common/account/sg-helpers");
const decimal_js_1 = __importDefault(require("decimal.js"));
const ibc_config_ab_json_1 = __importDefault(require("../../common/config/ibc-config-ab.json"));
const ibc_config_ac_json_1 = __importDefault(require("../../common/config/ibc-config-ac.json"));
...
function _verifyRpc(rpcList, prefix) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let url of urlList) {
            ...
            try {
                const sgQueryHelpers = yield (0, sg_helpers_1.getSgQueryHelpers)(url);
                if (!sgQueryHelpers)
                    return;
                const { getAllBalances } = sgQueryHelpers;
                yield (0, utils_1.specifyTimeout)(getAllBalances((0, clients_1.getAddrByPrefix)(envs_1.DAPP_ADDRESS, prefix)));
                urlChecked = url;
                break;
            }
            catch (error) {
...
function _verifyRpcList(prefixAndRpcList) {
    return __awaiter(this, void 0, void 0, function* () {
        let resultList = [];
        ...
        for (let [prefix, chainType, rpcList] of prefixAndRpcList) {
            try {
                const rpcChecked = yield _verifyRpc(rpcList, prefix);
...
function _queryNetworksData(mainList, testList, allowList, ignoreList) {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function* () {
        let promises = [];
...
function getChainRegistry(allowList, ignoreList) {
    return __awaiter(this, void 0, void 0, function* () {
        const { main, test } = yield _queryNetworkNames();
        return yield _queryNetworksData(main, test, allowList, ignoreList);
    });
}
...
function _getAllGrants(grantee, chainRegistryResponse, chainType) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let chain of chainRegistryResponse) {
            ...
            if (!rest)
                continue;
            const urlGrants = `${rest}/cosmos/authz/v1beta1/grants/grantee/${(0, clients_1.getAddrByPrefix)(grantee, chain.prefix)}`;
            const fn = () => __awaiter(this, void 0, void 0, function* () {
                try {
...
function getDappAddressAndDenomList(osmoAddress, chainRegistry) {
    ...
    for (let { denomIbc, prefix } of chainRegistry) {
        ...
        dappAddressAndDenomList.push([
            (0, clients_1.getAddrByPrefix)(osmoAddress, prefix),
            denomIbc,
        ]);
    }
